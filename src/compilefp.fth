...
target_name read" forth_fp_image"
0 target_name 1- c!              -- For QDOS


cr cr .( Loading host.fth)     include host.fth
cr cr .( Loading hostfp.fth)   include hostfp.fth
cr cr .( Loading primitives)   target_include prim_fp_obj
...
cr cr .( Loading fpmaths.fth)  cross_compile  fpmaths.fth
